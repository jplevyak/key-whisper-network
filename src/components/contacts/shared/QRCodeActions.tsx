  ...
  return (
    <>
      ...
      {showScanConfirmDialog && (
        <AlertDialog open={showScanConfirmDialog} onOpenChange={setShowScanConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Confirm Scanned Key</AlertDialogTitle>
              <AlertDialogDescription>
                Do you want to use this scanned encryption key? 
                This action may clear existing chat history for the contact.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <Dialog open={showQRGenerator} onOpenChange={setShowQRGenerator}>
          <DialogContent>
            ...
            <QRCodeGenerator
              ...
              onAccept={(keyFromGenerator) => { // Assuming QRCodeGenerator's onAccept provides the key
