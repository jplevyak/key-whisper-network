...
export class SecureStorage {
  ...
  async initializeWithKey(newDerivedKey: CryptoKey, dbManager?: IDBManagerType): Promise<void> {
    ...
    // Only consider re-encryption if a standard key was actively retrieved from storage, not just auto-generated by init()
    const shouldReEncrypt = oldKey && !this.isUsingDerivedKey && this.standardKeyWasRetrievedFromStorage;
