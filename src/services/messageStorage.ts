...
export const loadMessagesFromStorage = async (): Promise<Record<string, Message[]> | null> => {
...
export const saveMessagesToStorage = async (messages: Record<string, Message[]>): Promise<void> => {
